...
sudo apt install python3 python3-requests python3-bs4 python3-lxml python3-aiohttp

# rhel-based distros
sudo dnf install python3 python3-requests python3-bs4 python3-lxml python3-aiohttp
```
